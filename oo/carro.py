"""
Você deve criar uma classe de carro que vai possuir
dois atributos compostos por outra duas classes:

1) Motor
2) Direção

O motor de responsabilidade de controlar a velocidade
...
A Direçãi terá a responsabilidade de controlar a direção. Ela oferece
